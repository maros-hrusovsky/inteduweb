  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="inteduwebApp.school.home.createOrEditLabel">
            <Translate contentKey="inteduwebApp.school.home.createOrEditLabel">Create or edit a School</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : schoolEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="school-name" type="text" name="name" />
              </AvGroup>
