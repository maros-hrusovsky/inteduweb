...
import { getSearchEntities, getEntities } from './school.reducer';
  ...
  return (
    <div>
      <h2 id="school-heading">
        <Translate contentKey="inteduwebApp.school.home.title">Schools</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="inteduwebApp.school.home.createLabel">Create new School</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('inteduwebApp.school.home.search')}
                />
        ...
        {schoolList && schoolList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="inteduwebApp.school.home.notFound">No Schools found</Translate>
            </div>
          )
        )}
      </div>
